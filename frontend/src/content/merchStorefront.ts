...
export const merchProducts: MerchProduct[] = [
  // Hoodies
  {
    ...
    description: "Cozy hoodie featuring Riley the bear in all his fuzzy glory. Perfect for chilly haunt nights.",
    category: 'hoodies',
    character: 'Riley',
  },
  {
    ...
    description: "Show your love for Ace with this playful minion-style character hoodie.",
    category: 'hoodies',
    character: 'Ace',
  },
  {
  ...
  // Posters
  {
    ...
    description: "High-quality 18x24 poster featuring Riley the bear in stunning detail.",
    category: 'posters',
    character: 'Riley',
  },
  {
  ...
  },
  {
    ...
    description: "Collectible poster featuring Riley, Ace, Kevin, and Rocky together.",
    category: 'posters',
  },
  // Plushies
  {
    ...
    description: "Adorable 12-inch plush of Riley the bear. Soft, cuddly, and perfect for hugs.",
    category: 'plushies',
    character: 'Riley',
  },
  {
