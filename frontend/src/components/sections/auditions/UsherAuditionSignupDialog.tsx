...
export function UsherAuditionSignupDialog({ open, onOpenChange }: UsherAuditionSignupDialogProps) {
  ...
  const handleChange = (field: string, value: string) => {
    ...
    if (field === 'age') {
      ...
      if (value && (isNaN(ageNum) || ageNum < 16)) {
  ...
  const handleClose = () => {
    ...
    setTimeout(() => {
      setSubmitted(false);
      setFormData({ name: '', age: '', phone: '', email: '', availability: '', experience: '' });
      setAgeError('');
    }, 300);
  };
        ...
        <DialogHeader>
          <div className="relative w-full h-32 overflow-hidden rounded-lg mb-2">
            ...
            <div className="absolute bottom-2 left-2 flex gap-2">
              <Badge className="bg-primary text-primary-foreground text-xs">Ages 16+</Badge>
              <Badge variant="outline" className="border-primary/50 text-primary text-xs">March 2–3, 2027</Badge>
            </div>
          </div>
          ...
          <DialogDescription className="text-muted-foreground">
            Audition dates: <strong className="text-foreground">March 2–3, 2027 | 2:00–7:00 PM</strong>
          </DialogDescription>
        </DialogHeader>
        ...
        {!isAuthenticated ? (
          ...
          <div className="text-center py-8 space-y-4">
            ...
            <p className="text-muted-foreground">
              Thank you for applying for the Usher position! We'll be in touch before the audition dates.
            </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <Label htmlFor="usher-availability">Availability for March 2–3, 2027 (2–7 PM) *</Label>
              <Input
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Button
                ...
                disabled={submitMutation.isPending || !!ageError || !formData.name || !formData.age}
              >
