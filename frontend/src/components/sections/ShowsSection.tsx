...
import { Theater, Clock, Calendar as CalendarIcon, Waves } from 'lucide-react';
              ...
              <CardHeader>
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex flex-col gap-2 shrink-0">
                    ...
                    {show.year && (
                      <Badge variant="outline" className="border-primary text-primary animate-pulse-slow">
                        Coming {show.year}
                      </Badge>
                    )}
                    {(show as any).specialTiming && (
                      <Badge variant="outline" className="border-accent text-accent flex items-center gap-1 animate-pulse-slow">
                        <Clock className="h-3 w-3" />
                        {(show as any).specialTiming}
                      </Badge>
                    )}
                    {(show as any).selectNights && (
                      <Badge variant="outline" className="border-muted-foreground text-muted-foreground flex items-center gap-1 animate-pulse-slow">
