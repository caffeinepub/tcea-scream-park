      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <AlertDescription className="text-sm">
            Blackjack contains intense carnie and clown-themed horror, strobe
            lights, loud noises, confined spaces, and extreme jump scares. Not
            recommended for guests with heart conditions, anxiety disorders, or
            coulrophobia (fear of clowns). Pregnant guests should not enter. You
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-2xl text-muted-foreground italic mb-6">
              {house?.tagline ??
                "The house always wins. Your soul is the ante."}
            </p>
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            <h2 className="text-3xl font-bold text-destructive mb-4">
              Step Into the Big Top of Terror
            </h2>
            <p className="text-lg leading-relaxed mb-6">
              Step right up to the most twisted carnival on earth — if you dare.
              Blackjack is a deranged carnie and clown-themed haunted house
              where the big top has gone completely mad. Demented carnies deal
              cards soaked in blood, manic clowns lurk behind every rigged game
              booth, and the funhouse mirrors show you things that can't be
              unseen.
            </p>
            <p className="text-lg leading-relaxed mb-6">
              The ringmaster has lost his mind, the performers have lost their
              humanity, and the only way out is through. Navigate through the
              twisted midway, the hall of broken mirrors, the rigged game
              gallery, and the big top finale where the real show begins. Every
              corner hides a new nightmare, every shadow conceals a grinning
              face.
            </p>
            <p className="text-lg leading-relaxed mb-6">
              Place your bets, spin the wheel of terror, and pray the house
              doesn't collect what it's owed. In Blackjack, everyone loses — but
          ...
          <div className="bg-card/50 border border-destructive/20 rounded-lg p-6">
            ...
            <ul className="space-y-2 text-base leading-relaxed text-foreground/90">
              ...
              <li className="flex items-start gap-2">
                <span className="text-destructive mt-1">🎪</span>
                <span>
                  Twisted funhouse mirrors and disorienting carnival
                  environments
                </span>
              </li>
              <li className="flex items-start gap-2">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="relative overflow-hidden rounded-lg border border-destructive/20 group">
                ...
                <p className="absolute bottom-2 left-2 text-xs text-muted-foreground font-semibold">
                  The Twisted Midway
                </p>
              </div>
              <div className="relative overflow-hidden rounded-lg border border-destructive/20 group">
