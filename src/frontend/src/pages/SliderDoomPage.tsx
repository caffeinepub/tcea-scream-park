...
export function SliderDoomPage() {
  const booth = foodBooths.booths.find((b) => b.name === "Slider Doom");
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="bg-card/80 backdrop-blur-sm border-destructive/30 overflow-hidden">
          <div className="relative h-[500px] overflow-hidden">
            <img
              src={generatedImages.foodBooths["Slider Doom"]}
              alt={booth.name}
          ...
          <CardHeader>
            ...
            {booth.label && (
              <CardDescription className="text-muted-foreground italic text-lg">
                {booth.label}
              </CardDescription>
            )}
