...
export function DancerAuditionPage() {
        ...
        <Card className="bg-card/90 backdrop-blur-sm border-destructive/20">
          <CardHeader>
            ...
            <p className="text-muted-foreground text-lg">
              Apply to join our elite dance team and perform in our shows
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <Alert variant="destructive" className="border-2 border-destructive bg-destructive/10">
              ...
              <AlertTitle className="text-xl font-bold">PERFORMANCE POSITION</AlertTitle>
              <AlertDescription>
                This role requires dance experience, physical stamina, and the ability to perform 
                in high-energy shows. You will be part of our spectacular performances.
              </AlertDescription>
            </Alert>
