    ...
    <>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(255, 100, 0, 0.18) 0%, rgba(0, 0, 0, 0.3) 50%, rgba(0, 100, 0, 0.12) 100%)",
          }}
        />
      </div>
      ...
      <div className="fixed inset-0 pointer-events-none z-0 bg-black">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at center, transparent 0%, rgba(20, 10, 0, 0.75) 35%, rgba(0, 0, 0, 0.95) 100%)",
          }}
        />
      </div>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 0%, rgba(255, 100, 0, 0.35) 0%, rgba(0, 255, 100, 0.25) 40%, transparent 70%)",
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage:
            "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(255, 100, 0, 0.04) 2px, rgba(255, 100, 0, 0.04) 4px)",
        }}
      />
