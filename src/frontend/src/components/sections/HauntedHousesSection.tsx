...
import { Clock, Eye, Home, Shield, Zap } from "lucide-react";
import { Section } from "../layout/Section";

const DETAIL_PAGE_HOUSES = [
  "Open Ice Tomb",
  "Wax Works",
  "Toys Come to Play",
  "Obsession Scream",
    ...
    >
      <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {hauntedHouses.houses.map((house) => {
          const imagePath =
            generatedImages.hauntedHouses[
              house.name as keyof typeof generatedImages.hauntedHouses
            ];
          const hasDetailPage = DETAIL_PAGE_HOUSES.includes(house.name);
          const isOpen2026 = "open2026" in house && house.open2026 === true;
