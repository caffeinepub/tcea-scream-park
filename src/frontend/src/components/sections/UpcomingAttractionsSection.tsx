...
const upcomingAttractions: Attraction[] = [
  {
    name: 'Starr Eyes',
    type: 'Restaurant',
    description: 'An upscale horror-themed dining experience where neon stars illuminate eerie ambiance. Indulge in gourmet cuisine while surrounded by unsettling décor and mysterious shadows. Every meal comes with a side of spine-tingling atmosphere.',
  ...
  },
  {
    name: 'Lone Starr',
    type: 'Stunt Show',
    description: 'Action-packed live stunt performances set in a western horror landscape. Watch as daredevils perform dangerous tricks, death-defying stunts, and explosive sequences that will leave you breathless. This is not for the faint of heart.',
  ...
  },
  {
    name: 'Under the Sea',
    type: 'Live Show',
    description: 'Dive into an underwater nightmare with this spectacular live show featuring pyrotechnic effects bursting from the water. Sea creatures come alive in terrifying ways, and hidden within the performance lies a subtle tribute to Six Flags America\'s aquatic legacy. Prepare for a splash of horror.',
  ...
  },
  {
    name: 'Chaos Breaths',
    type: 'Themed Land',
    description: 'Our biggest expansion yet—a massive new themed land where chaos reigns supreme. Experience chaotic breath effects, dark atmospheric environments, multiple live shows, and meet-and-greets with all your favorite costume characters. This land will redefine terror.',
    ...
    subAttractions: [
      {
        ...
        type: 'Live Show',
        description: 'A dramatic spectacle combining water and fire special effects in an unforgettable performance. Watch as flames dance over cascading water in a mesmerizing display of elemental chaos.',
        imagePath: '/assets/generated/fire-over-water-show.dim_800x600.png',
      },
      {
        name: 'Dragon Lair',
        type: 'Live Show',
        description: 'Enter the lair of a menacing dragon in this immersive show experience. Witness the dragon\'s fury through stunning effects, theatrical performances, and heart-pounding encounters.',
...
export function UpcomingAttractionsSection() {
  ...
  const attractionsByYear = upcomingAttractions.reduce((acc, attraction) => {
                    ...
                    <CardContent className="space-y-6">
                              ...
                              <div className="relative w-24 h-24 shrink-0 rounded overflow-hidden">
                                {!imageErrors.has(subAttraction.imagePath) ? (
                                  <img
                                    ...
                                    className="w-full h-full object-cover"
                                    onError={() => handleImageError(subAttraction.imagePath)}
                                  />
                                ) : (
                                  <div className="w-full h-full bg-muted flex items-center justify-center">
                      ...
                      <div className="border-t border-border/50 pt-4">
                        <p className="text-sm text-muted-foreground flex items-center gap-2">
                          ...
                          All costume characters available for meet-and-greets throughout the land
                        </p>
                      </div>
                    </CardContent>
                  )}
