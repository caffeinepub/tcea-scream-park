    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 space-y-8 max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-foreground/90 max-w-3xl mx-auto leading-relaxed font-medium drop-shadow-lg">
          Welcome to the 2028 Fire Remix show—an explosive spectacle of dancers,
          lasers, and pure adrenaline! Catch the electrifying performances at
          the Remix Arena with showtimes at 7 PM, 9 PM, and 11 PM. This is not
          just a show—it's a sensory overload of rhythm, fire, and fearless
          energy that will leave you breathless!
        </p>
