        ...
        {newHouses.map((house) => (
          ...
          >
            ...
            <CardContent className="pt-6">
              <p className="text-white leading-relaxed">{house.teaser}</p>
