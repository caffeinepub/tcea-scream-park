...
export function HauntedHouseSupervisorAuditionSignupDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (Number.isNaN(ageNum) || ageNum < 1) return;
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto bg-card border-destructive/30">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            Auditions coming{" "}
            <strong className="text-foreground">2026/27 season</strong>. Submit
            your interest now.
          </DialogDescription>
        </DialogHeader>
        ...
        {!isAuthenticated ? (
          ...
          <div className="text-center py-8 space-y-4">
            ...
            <p className="text-muted-foreground">
              Thank you for your interest in the Haunted House Supervisor role!
              We'll reach out when auditions open for the 2026/27 season.
            </p>
            <Button
              onClick={handleClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleChange("leadershipExperience", e.target.value)
                }
